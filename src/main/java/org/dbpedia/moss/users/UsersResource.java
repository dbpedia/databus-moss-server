...
public class UsersResource implements UsersApi {
    ...
    public Response getCurrentUser() {
        ...
        try {
            UserInfo userInfo;
            if (sub == null) {
                userInfo = buildEffectivePrincipal();
            } else {
                userInfo = userDatabaseManager.getUserInfoBySub(sub);
                if (userInfo == null) {
                ...
                applyEffectiveRolesAndPermissions(userInfo);
            }
    ...
    private UserInfo buildEffectivePrincipal() {
        UserInfo userInfo = new UserInfo();
        applyEffectiveRolesAndPermissions(userInfo);
        return userInfo;
    }

    private void applyEffectiveRolesAndPermissions(UserInfo userInfo) {
