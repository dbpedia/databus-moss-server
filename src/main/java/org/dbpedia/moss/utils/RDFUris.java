...
public final class RDFUris {
    ...
    public static final String MOSS_DATABUS_METADATA_LAYER = "http://dataid.dbpedia.org/ns/moss#DatabusMetadataLayer";
    ...
    public static final String MOSS_EXTENDS = "http://dataid.dbpedia.org/ns/moss#extends";
    
    public static final String MOSS_CONTENT = "http://dataid.dbpedia.org/ns/moss#content";
