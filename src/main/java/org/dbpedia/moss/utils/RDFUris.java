...
public final class RDFUris {
    ...
    public static final Property DTC_TITLE = model.createProperty("http://purl.org/dc/terms/title");

    public static final Property DCT_DESCRIPTION = model.createProperty("http://purl.org/dc/terms/description");
